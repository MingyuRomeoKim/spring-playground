package com.mingyu.playground.jwt.filter;
...
import com.mingyu.playground.jwt.infrastructure.CustomUserDetails;
import com.mingyu.playground.jwt.infrastructure.JwtAuthenticationToken;
import com.mingyu.playground.jwt.util.JwtTokenizer;
...
public class TokenAuthenticationFilter extends OncePerRequestFilter {
    ...
    private void getAuthentication(String token) {
        ...
        UUID id = claims.get("id", UUID.class); // 사용자 ID를 가져옴
