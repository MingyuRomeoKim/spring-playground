package com.mingyu.playground.domain.auth.dto.request;

import com.mingyu.playground.common.validations.PasswordMatches;
...
public class AuthSignUpRequestDto {
    ...
    @Schema(description = "비밀번호 확인", defaultValue = "1q2w3e4r!!")
